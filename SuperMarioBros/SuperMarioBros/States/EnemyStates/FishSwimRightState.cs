...
{
    class FishSwimRightState:IEnemyState
    {
        private Fish fish;
        ...
        public FishSwimRightState(Fish fish)
        {
            this.fish = fish;
            sprite = EnemyFactory.Instance.CreateFishSwimRight();
            Width = sprite.Width;
        ...
        {
            fish.State = new FishSwimLeftState(fish);
